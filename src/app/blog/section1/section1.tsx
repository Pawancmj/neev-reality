  ...
  return (
    ...
    >
      ...
      <section className="grid gap-10 items-start lg:grid-cols-[2fr,1fr]">
        ...
        >
          {cards.map((card) => (
            <Link key={card.id} href={`/blog/${card.id}`}>
              <article
                className="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm cursor-pointer"
        ...
        {/* Sidebar */}
        <aside
          className="absolute right-30 mt-5 mx-auto h-fit space-y-6 rounded-2xl p-5 md:p-6"
          style={{ width: 387 }}
        >
          {/* Search */}
          <section
          ...
          >
            <div>
              ...
              />
              <h3
                className="mb-4 relative top-1 text-sm font-semibold md:text-base ml-14"
                style={{ width: 387 }}
              >
                Search Blogs
              </h3>
