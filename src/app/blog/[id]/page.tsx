  ...
  return (
    <main className="bg-[#f5f5f5] w-full">
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        {/* META */}
        <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between text-sm text-gray-500">
          ...
          <div className="flex items-center gap-2">
            ...
            <Image src={blog.share} alt="" width={40} height={40} />
          </div>
        </div>

        {/* HERO IMAGE */}
        <div className="relative mt-5 w-full aspect-[16/7] rounded-lg overflow-hidden">
          <Image
            src={blog.heroImage}
            alt={blog.heroAlt}
            fill
                ...
                <details className="group bg-[#FDECEC] rounded-lg p-5">
                  ...
                  <div className="mt-4 space-y-2 text-sm text-gray-800">
                    <ol className="list-decimal pl-5 space-y-1">
                      ...
                      <li>
                        <a href="#why-invest-smart-city" className="hover:underline">
                          What makes a Smart City Investment Worthy
                        </a>
                      </li>
                      <li>
                        Top 10 Smart Cities in India
                        <ol className="list-decimal pl-5 mt-1 space-y-1">
                          <li><a href="#bhubaneswar" className="hover:underline">Bhubaneswar</a></li>
                          <li><a href="#pune" className="hover:underline">Pune</a></li>
                          <li><a href="#indore" className="hover:underline">Indore</a></li>
                          <li><a href="#ahmedabad" className="hover:underline">Ahmedabad</a></li>
                          <li><a href="#jaipur" className="hover:underline">Jaipur</a></li>
                          <li><a href="#coimbatore" className="hover:underline">Coimbatore</a></li>
                          <li><a href="#chandigarh" className="hover:underline">Chandigarh</a></li>
                          <li><a href="#hyderabad" className="hover:underline">Hyderabad</a></li>
                        </ol>
                      </li>
                      <li>
                        <a href="#why-invest-smart-city" className="hover:underline">
                          Advantages of Investing in or Buying into a Smart City
                        </a>
                      </li>
                      <li>
                        <a href="#why-invest-smart-city" className="hover:underline">
